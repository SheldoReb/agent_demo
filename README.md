...
- **Local command execution** – Enables the assistant to run shell commands inside the container using `LocalCommandLineExecutor`.
...
- `demo.py` – Script that wires together the Autogen agents, registers the MarkItDown tool, and runs a sample dialogue.
